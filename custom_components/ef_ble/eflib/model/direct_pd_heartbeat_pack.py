...
class DirectPdHeartbeatPack(RawData):
    ...
    reserved: Annotated[int, "5s", "reserved"]
    sys_chg_flag: Annotated[int, "B", "sysChgFlag"]


class DirectPdDeltaHeartbeatPack(DirectPdHeartbeatPack):
    wifi_ver: Annotated[int, "I", "wifiVer"]
    ...
    reserved_delta: Annotated[int, "2s", "reservedDelta"]
    ext_rj45_port: Annotated[int, "B", "extRj45Port"]
    ext_3p8_port: Annotated[int, "B", "ext3p8Port"]
    ext_4p8_port: Annotated[int, "B", "ext4p8Port"]
    icon_rechg_time_mode: Annotated[int, "B", "iconRechgTimeMode"]
    usbqc_used_time_delta: Annotated[int, "I", "usbqcUsedTime"]
    ...
    screen_state: Annotated[int, "14s", "screenState"]
