...
# Create minimal stub modules for custom_components and ef_ble
# This prevents their __init__.py files from being executed
custom_components = ModuleType("custom_components")
custom_components.__path__ = []
sys.modules["custom_components"] = custom_components

ef_ble = ModuleType("custom_components.ef_ble")
ef_ble.__path__ = [str(Path(__file__).parent.parent / "custom_components" / "ef_ble")]
